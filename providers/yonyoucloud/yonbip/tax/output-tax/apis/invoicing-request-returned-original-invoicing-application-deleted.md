...
- 完整调用地址：https://c2.yonyoucloud.com/iuap-api-gateway/yonbip/tax/invoiceclient-web/api/invoiceApply/del
...
- 调用 URL：`https://c2.yonyoucloud.com/iuap-api-gateway/yonbip/tax/invoiceclient-web/api/invoiceApply/del?access_token={access_token}`
...
```bash
curl -X POST 'https://c2.yonyoucloud.com/iuap-api-gateway/yonbip/tax/invoiceclient-web/api/invoiceApply/del?access_token=访问令牌' \
...
1. `FormParam.requestdatas`
   ...
   - 数组：否
   - 必填：是
   - 示例/默认值：`[{     "FPQQLSH" : "1460156051597926400",     "XSF_NSRSBH" : "111222333456333" }]`
   - 说明：Invoicing Application Delete Parameter
