...
- 调用 URL：`https://c2.yonyoucloud.com/iuap-api-gateway/yonbip/tax/invoiceclient-web/api/invoiceApply/invalidWithJson?access_token={access_token}`
...
```bash
curl -X POST 'https://c2.yonyoucloud.com/iuap-api-gateway/yonbip/tax/invoiceclient-web/api/invoiceApply/invalidWithJson?access_token=访问令牌' \
...
```text
Url: /yonbip/tax//api/invoiceApply/invalidWithJson?access_token=访问令牌  
Body: {
	"fpHm": "1222263555",
	"fpDm": "1225222"
}
